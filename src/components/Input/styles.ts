...
export const LabelContainer = styled(Animated.View)((props: StyledProps) => ({
  position: 'absolute',
  top: '50%',
  left: 20,
}))
...
export const Label = styled.Text((props: TextProps) => ({
  ...
  fontFamily: props.isFocused ? props.theme.typography.primary.bold : props.theme.typography.primary.bold,
  fontSize: 18,
}))

export const ErrorContainer = styled.View((props: TextProps) => ({
  flexDirection: 'row',
  marginTop: 12,
  marginLeft: 8,
  // alignItems: 'center',
