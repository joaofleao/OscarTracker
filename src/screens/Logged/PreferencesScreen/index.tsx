...
const PreferencesScreen = ({ navigation }: PreferencesScreenProps): JSX.Element => {
  ...
  const getCast = (item: {
    ...
    return (
      <Spoiler>
        <View
        // className="bg-zinc-800/40 rounded-xl items-center justify-center"
        >
          <Image
            source={item.image}
        ...
        >
          <View
          // className="bg-zinc-800/40 rounded-xl"
          >
            <Text
              numberOfLines={2}
  ...
  const screens = [
    {
      ...
      content: (
        ...
        >
          ...
          >
            <Text
            // className="text-white font-primaryBold text-4xl mb-4 w-full text-center"
            >
              Welcome!
            </Text>
            <Text
            // className="text-white font-primaryBold text-2xl mb-4 w-full text-center"
            >
              Time to choose your spoiler preferences
            </Text>
          </View>
          <Text
          // className="text-white font-primaryRegular text-lg mb-12 w-full text-center "
          >
    ...
    },
    {
      ...
      content: (
        ...
        >
          ...
          // className="text-white font-primaryBold text-2xl mb-4 w-full"
          >
            {" Do you consider a movie's poster a spoiler?"}
          </Text>
          <Text

          // className="text-white font-primaryRegular text-base w-full mb-4"
          >
    ...
    },
    {
      ...
      content: (
        ...
        >
          ...
          // className="text-white font-primaryRegular text-base mb-4  w-full"
          >
          ...
          >
            <Spoiler>
              ...
              >
                When an alien with amazing powers crash-lands near Mossy Bottom Farm, Shaun the
                Sheep goes on a mission to shepherd the intergalactic visitor home before a sinister
    ...
    },
    {
      ...
      content: (
        ...
        >
          ...
          // className="text-white font-primaryBold text-2xl mb-4 w-full"
          >
            And the movie ratings, are those spoilers?
          </Text>
          <Text
          ...
          <View style={{ alignItems: 'center' }}>
            <Spoiler text="Show Score">
              ...
              >
                ...
                />
                <Text
                // className="text-white font-primaryBold text-2xl mt-2"
                >
                  4.2
                </Text>
              </View>
    ...
    },
    {
      ...
      content: (
        ...
        >
          ...
          <Text
          // className="text-white font-primaryRegular text-lg mb-4 w-full text-center "
          >
  ...
  return (
    <Global.Screen>
      ...
      />
      <View
      // className={`items-center justify-end ${Platform.OS === 'android' ? 'mb-6' : ''}`}
      >
