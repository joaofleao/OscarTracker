...
import { View, Text, TouchableOpacity, FlatList, ListRenderItemInfo, Image, ScrollView, Linking } from 'react-native'
import {
  HeaderComponent,
  IconComponent,
  ModelComponent,
    ...
    <ModelComponent>
      ...
      <ScrollView>
        ...
        <View className='mt-4'>
          ...
          {!movieProviders ? (
            <Text className='mx-4 font-primaryRegular text-white text-base text-justify'>
